...
public class Lengbanlist extends JavaPlugin {
    ...
    private String getDefaultLanguageContent() {
        return "prefix: \"§7[Lengbanlist] \"\n" +
               ...
               "help_commands:\n" +
               "  list: \"§b§l/lban list - §3查看被封禁的名单\"\n" +
               "  broadcast: \"§b§l/lban a - §3广播当前封禁人数\"\n" +
               "  toggle: \"§b§l/lban toggle - §3开启/关闭自动广播\"\n" +
               "  model: \"§b§l/lban model <模型名称> - §3切换模型\"\n" +
               "  reload: \"§b§l/lban reload - §3重新加载配置\"\n" +
               "  add: \"§b§l/lban add <玩家名> <天数> <原因> - §3添加封禁\"\n" +
               "  remove: \"§b§l/lban remove <玩家名> - §3移除封禁\"\n" +
               "  mute: \"§b§l/lban mute <玩家名> <原因> - §3禁言玩家\"\n" +
               "  unmute: \"§b§l/lban unmute <玩家名> - §3解除禁言\"\n" +
               "  list_mute: \"§b§l/lban list-mute - §3查看禁言列表\"\n" +
               "  help: \"§b§l/lban help - §3显示帮助信息\"\n" +
               "  open: \"§b§l/lban open - §3打开可视化操作界面\"\n" +
               "  getIP: \"§b§l/lban getIP <玩家名> - §3查询玩家的 IP 地址\"\n" +
               "  ban_ip: \"§b§l/ban-ip <IP地址> <天数> <原因> - §3封禁 IP 地址\"\n" +
               "  unban_ip: \"§b§l/unban-ip <IP地址> - §3解除 IP 封禁\"\n" +
               "  warn: \"§b§l/lban warn <玩家名> <原因> - §3警告玩家，三次警告将自动封禁！\"\n" +
               "  unwarn: \"§b§l/lban unwarn <玩家名> - §3移除玩家的警告记录。\"\n" +
               "  check: \"§b§l/lban check <玩家名/IP> - §3检查玩家或IP的封禁状态\"\n" +
               "  report: \"§b§l/report <玩家名> <原因> - §3举报玩家\"\n" +
