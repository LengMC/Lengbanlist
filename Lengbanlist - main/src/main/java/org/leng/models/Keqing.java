...
public void showHelp(CommandSender sender) {
    ...
    Utils.sendMessage(sender, "§b§l/report <玩家名> <原因> - §3§o发现不守规矩的行为？及时举报，刻晴会高效处理！");
    Utils.sendMessage(sender, "§7-> §b§l/report accept <举报编号> - §3§o受理举报，开始处理不守规矩的行为！");
    Utils.sendMessage(sender, "§7-> §b§l/report close <举报编号> - §3§o关闭举报，问题已解决！");
    Utils.sendMessage(sender, "§b§l/lban admin - §3§o打开管理员界面，高效管理举报。");
