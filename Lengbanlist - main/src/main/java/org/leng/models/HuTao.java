...
public void showHelp(CommandSender sender) {
    ...
    Utils.sendMessage(sender, "§b§l/report <玩家名> <原因> - §3§o发现捣乱的家伙？快告诉胡桃，让往生堂来处理！");
    Utils.sendMessage(sender, "§7-> §b§l/report accept <举报编号> - §3§o受理举报，开始处理捣乱行为！");
    Utils.sendMessage(sender, "§7-> §b§l/report close <举报编号> - §3§o关闭举报，问题已解决！");
    Utils.sendMessage(sender, "§b§l/lban admin - §3§o打开管理员界面，管理捣乱行为。");
